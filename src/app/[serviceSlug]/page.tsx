...
export async function generateMetadata({params}: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {canonical: `https://www.highlightschicago.com/reviews/${data.page.serviceSlug}`},
  }
}
        ...
        <section className="review-detail-content">
          <div className="collection-wrap review-detail-grid">
            <aside className="review-detail-sidebar">
              ...
              <nav>
                <Link href={{pathname: '/', query: {view: 'rating'}}}><span>By rating</span><b>→</b></Link>
                <Link href={{pathname: '/', query: {view: 'years'}}}><span>By year</span><b>→</b></Link>
                <Link href={{pathname: '/', query: {view: 'equipment'}}}><span>All equipment</span><b>→</b></Link>
                <a href={`https://www.highlightschicago.com/services/${page.serviceSlug}/${page.areaSlug}`}><span>View this service</span><b>→</b></a>
              </nav>
